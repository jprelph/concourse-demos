...
# naxsi-nginx-module
ARG VER_NAXSI=1.3
ENV VER_NAXSI=$VER_NAXSI

# luasocket-lua-module
ARG VER_LUASOCKET=v3.0-rc1
ENV VER_LUASOCKET=$VER_LUASOCKET

# https://github.com/nginx/nginx/releases
ARG VER_NGINX=1.20.0
...
ARG NGINX_BUILD_CONFIG="\
        ...
        --add-module=/naxsi-${VER_NAXSI}/naxsi_src \
"
...
LABEL maintainer="it CORE DEVOPS" \
